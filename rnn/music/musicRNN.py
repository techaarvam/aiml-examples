...
class musicRNN(nn.Module):
    def __init__(self, dim, hidden_dim ):
        ...
        # there are 3 ouputs accent(0,1,2), melody_raw(0-24), note_boundary (true,false). 
        output_size = 30  # 3 + 25 + 2 . each head will do an argMax!
    ...
    def forward(self, full_x, h= None):
        ...
        for i in range(full_x.shape[1]):
            ...
            outputs.append(self.mlp(h[args.num_layers-1]))
